...
export const Route = createFileRoute('/_demo/table')({
	component: TableDemo,
});
...
// biome-ignore lint: Demo table component requires any type for TanStack Table filter
...
// biome-ignore lint: Demo table component requires any type for TanStack Table sort
...
function TableDemo() {
	...
	// biome-ignore lint: Demo table component requires any type for TanStack Table
...
// biome-ignore lint: Demo table component requires any type for TanStack Column
